...
"""
    thingspaceconnectivitymanagementapilib.models.custom_fields_update_request
...
class CustomFieldsUpdateRequest(BaseModel):
    ...
    Attributes:
        ...
        custom_fields_to_update (list of KvPair): TODO: type description
            here.
    ...
    def from_dictionary(cls, 
        ...
        if dictionary == None:
            ...
            custom_fields_to_update = None
            if dictionary.get("customFieldsToUpdate") != None:
                custom_fields_to_update = list()
                for structure in dictionary.get("customFieldsToUpdate"):
                    custom_fields_to_update.append(KvPair.from_dictionary(structure))
            devices = None
